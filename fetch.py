#!/usr/bin/env python3
"""
Recuperation des codes promo Private Sport Shop depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/privatesportshop.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/privatesportshop.fr"
STORE_NAME = "Private Sport Shop"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Private Sport Shop depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-privatesportshop)"
    }
    try:
